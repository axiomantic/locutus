...
- **End-to-End Cryptography & Cryptographic Authentication**:
  ...
  - **Workflow Output Encryption**: Step outputs stored during workflow resolution are transparently encrypted with AES-256 when encryption is enabled, preventing secret leakage in pipeline state.
